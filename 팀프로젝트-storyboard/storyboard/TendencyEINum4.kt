 ...
 * Use the [TendencyEINum4.newInstance] factory method to
 * create an instance of this fragment.
 */
class TendencyEINum4 : Fragment(),View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_tendency_e_i_num4, container, false)
        init(view)
        listen()
        return view
    }
    fun init(view:View){
        titleNum = view.findViewById(R.id.ei_num4_title)
        question1 = view.findViewById(R.id.ei_num4_question1)
        question2 = view.findViewById(R.id.ei_num4_question2)
        radio1 = view.findViewById(R.id.ei_num4_radio1)
        radio2 = view.findViewById(R.id.ei_num4_radio2)
    ...
    override fun onClick(v: View?) {
        ...
        when(id){
            ...
            R.id.ei_num4_question1->{
                radio1.isChecked = true
                radio1.callOnClick()
            }
            R.id.ei_num4_question2->{
