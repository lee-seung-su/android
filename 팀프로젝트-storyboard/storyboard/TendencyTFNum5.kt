 ...
 * Use the [TendencyTFNum5.newInstance] factory method to
 * create an instance of this fragment.
 */
class TendencyTFNum5 : Fragment(),View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_tendency_t_f_num5, container, false)
        init(view)
        listen()
    ...
    fun init(view:View){
        titleNum = view.findViewById(R.id.tf_num5_title)
        question1 = view.findViewById(R.id.tf_num5_question1)
        question2 = view.findViewById(R.id.tf_num5_question2)
        radio1 = view.findViewById(R.id.tf_num5_radio1)
        radio2 = view.findViewById(R.id.tf_num5_radio2)
    ...
    override fun onClick(v: View?) {
        ...
        when(id){
            ...
            R.id.tf_num5_question1->{
                radio1.isChecked = true
                radio1.callOnClick()
            }
            R.id.tf_num5_question2->{
