 ...
 * Use the [TendencyJPNum2.newInstance] factory method to
 * create an instance of this fragment.
 */
class TendencyJPNum2 : Fragment(),View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_tendency_j_p_num2, container, false)
        init(view)
        listen()
        return view
    }
    fun init(view:View){
        titleNum = view.findViewById(R.id.jp_num2_title)
        question1 = view.findViewById(R.id.jp_num2_question1)
        question2 = view.findViewById(R.id.jp_num2_question2)
        radio1 = view.findViewById(R.id.jp_num2_radio1)
        radio2 = view.findViewById(R.id.jp_num2_radio2)
    ...
    override fun onClick(v: View?) {
        ...
        when(id){
            ...
            R.id.jp_num2_question1->{
                radio1.isChecked = true
                radio1.callOnClick()
            }
            R.id.jp_num2_question2->{
