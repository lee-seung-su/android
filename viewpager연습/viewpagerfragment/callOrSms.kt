...
class fragd : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_callorsms, container, false)
        init(view)
        listen(view)
    ...
    fun init(view : View){
        webButton = view.findViewById(R.id.callOrSms_web_button)
        naverButton = view.findViewById(R.id.callOrSms_naver_button)
        dialButton = view.findViewById(R.id.callOrSms_dial_button)
        callButton = view.findViewById(R.id.callOrSms_call_button)
        enableButton = view.findViewById(R.id.enable_button)
        disableButton = view.findViewById(R.id.disable_button)
        smsButton = view.findViewById(R.id.callOrSms_sms_button)

        webEdit = view.findViewById(R.id.callOrSms_web_edit)
        phoneEdit = view.findViewById(R.id.callOrSms_phone_edit)
        phoneWatch = view.findViewById(R.id.callOrSms_phone_edit_watcher)
    }
