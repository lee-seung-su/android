...
class fraga() : Fragment() {
    ...
    fun init(view : View){
        kakaoData = makeData()
        clearButton = view.findViewById(R.id.recyclerview_clear_button)
        addButton = view.findViewById(R.id.recyclerview_add_button)
        deleteButton = view.findViewById(R.id.recyclerview_delete_button)

        totalNum = view.findViewById(R.id.recyclerview_total_num)

        recycler = view.findViewById(R.id.recyclerview_recycler_view)
    ...
    fun listen(){
        ...
        addButton.setOnClickListener{
            ...
            refresh()
            recycler.scrollToPosition(dataNum-1)
